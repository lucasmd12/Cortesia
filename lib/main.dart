...
import 'screens/maps/immersive_map_screen.dart';
...
import 'providers/map_navigation_provider.dart'; // 1. IMPORT DO NOVO PROVIDER
// ===================== FIM DA MODIFICAÇÃO ======================
  ...
  Widget build(BuildContext context) {
    ...
    return MultiProvider(
      providers: [
        ...
        // ==================== INÍCIO DA MODIFICAÇÃO ====================
        // 2. REGISTRO DO NOVO PROVIDER NA ÁRVORE DE WIDGETS
        ChangeNotifierProvider<MapNavigationProvider>(
        ...
        child: IncomingCallOverlay(
          child: MaterialApp(
            ...
            routes: {
              ...
              '/immersive-map': (context) => const ImmersiveMapScreen(),
              '/call': (context) {
