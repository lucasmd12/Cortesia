...
class ApiService {
  ...
  /// Limpa qualquer cache interno do ApiService
  /// Esta função é chamada durante o logout para garantir limpeza completa
  void clearCache() {
    Logger.info('ApiService: Cache interno limpo (se houver).');
    // Se você tiver cache interno no futuro, limpe aqui
    // Por exemplo: _internalCache?.clear();
  }
}
